...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cbConsole = QtGui.QComboBox(self.centralwidget)
        self.cbConsole.setGeometry(QtCore.QRect(370, 10, 161, 22))
        self.cbConsole.setObjectName(_fromUtf8("cbConsole"))
        ...
        self.listView.setGeometry(QtCore.QRect(10, 70, 151, 321))
